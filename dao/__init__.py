...
def conectar_cloudBD():
    con = psycopg2.connect(
        host= 'dpg-cnsdnrfjbltc73et71mg-a.oregon-postgres.render.com',
        database= 'ferascompcloud_xez3',
        user= 'ferascompcloud_xez3_user',
        password= 'm79hwzK8NF8OpavPuklICyWauDaGlXpp'
    )
    return con
